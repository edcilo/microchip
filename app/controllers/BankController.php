...
class BankController extends \BaseController {
	...
	{
		if ( Request::ajax() ) return $this->bankRepo->getActive(1, 'all', 'name', 'ASC');
	...
	{
		if ( Request::ajax() ) return $this->bankRepo->getActive(0, 'all', 'name', 'ASC');
	...
	public function show($slug, $id, $list)
	{
		...
		if ( Request::ajax() ) return Response::json($bank);
