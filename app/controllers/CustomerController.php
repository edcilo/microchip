...
class CustomerController extends \BaseController {
	...
	{
		if ( Request::ajax() ) return $this->customerRepo->getActive(1, 'all', 'name', 'ASC');
	...
	public function show($slug, $id)
	{
		...
		if ( Request::ajax() ) return Response::json($customer);
	...
	{
		if ( Request::ajax() ) return $this->customerRepo->getActive(0, 'all', 'name', 'ASC');
