...
class ProviderController extends \BaseController {
	...
	{
		if ( Request::ajax() ) return $this->providerRepo->getActive(1, 'all', 'name', 'ASC');

		$providers = $this->providerRepo->getActive(1, 'paginate', 'name', 'asc');
		foreach($providers as $provider) $this->providerFormat->formatData($provider);
	...
	{
		if ( Request::ajax() ) return $this->providerRepo->getActive(0, 'all', 'name', 'ASC');
	...
	public function show($slug, $id)
	{
		...
		if ( Request::ajax() ) return Response::json($provider);
	...
	public function search()
	{
		...
		if ( Request::ajax() ) {
			return $this->providerRepo->search($terms, 'ajax');
		} else {
