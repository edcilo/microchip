...
class PurchaseController extends \BaseController {
	...
	{
		if ( Request::ajax() ) return $this->purchaseRepo->getAll('all', 'folio', 'ASC');
	...
	{
		if ( Request::ajax() ) return $this->purchaseRepo->getIncomplete('all', 'folio', 'ASC');
	...
	public function show($slug, $id)
	{
		...
		if ( Request::ajax() ) return Response::json($purchase);
