<div class="">
    ...
    <div class="row">
        <strong>{{ Form::label('classification', 'Tipo de documento: ', ['class'=>'label50']) }}</strong>
        {{ Form::select('classification', trans('lists.classifications'), null, ['autofocus']) }}
    ...
    <div class="row">
        ...
        {{ Form::text('folio', null, ['title'=>'Este campo es obligatorio.', 'data-required'=>'required', 'data-numeric'=>'numeric', 'autocomplete'=>'off']) }}
        <div class="message-error">
    ...
    <div class="row">
        ...
        $ {{ Form::text('amount', null, ['class'=>'text-right', 'title'=>'Este campo es obligatorio.', 'autocomplete'=>'off', 'data-required'=>'required', 'data-numeric'=>'numeric']) }}
        <div class="message-error">
