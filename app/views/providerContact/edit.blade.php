    ...
    <div class="col col100 block description-product">
        ...
        <div class="col col100 form">
            ...
            <fieldset>
                ...
                <div class="flo col30 text-right">
                    <a href="{{ route('providerBank.create') }}" class="btn-green" title="Agregar banco">
            ...
            <fieldset>
                ...
                @if ( is_object( $provider->contacts ) )
                    <div class="flo col100 block description-product">
                        <h3 class="subtitle">Editar contacto</h3>
                    ...
                    @foreach ( $provider->contacts as $contact_l )
                        @if($contact_l->id != $contact->id)
                            <div class="flo col50 center">
                                <div class="block description-product">
                                    <div class="row">
                                        <strong>Nombre: </strong>
                                        {{ $contact_l->name }} {{ $contact_l->last_name }}
                                    </div>
                                    <div class="row">
