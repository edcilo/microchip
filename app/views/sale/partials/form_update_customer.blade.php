@if( p(78) )
    ...
    <div class="row flo col25 center">
        ...
        {{ Form::text('customer_id', null, ['class'=>'stopEnter nextInput', 'autocomplete'=>'off', 'data-required'=>'required', 'title'=>'Este campo es obligatorio.', 'data-url'=>route('customer.search'), 'data-customer'=>route('api.customer.get', 'CUSTOMER_ID')]) }}
